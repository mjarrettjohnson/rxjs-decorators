import { createMethodDecorator, InvalidReturnType } from './create-method-decorator';
import { createAccessorDecorator, IncorrectDecoratorType } from './create-accessor-decorator';
import {
...
import { createDecorator, InvalidMetadataForDecoratorError } from './create';
